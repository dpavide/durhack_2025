...
`;
  ...
  // NOTE: Removed the downloadPythonFile function to disable file saving behavior.
  ...
  const handleAskGemini = async () => {
    ...
    try {
      ...
      // NOTE: File download / saving intentionally disabled per request.
      setAiLoading(false);
    } catch (err: any) {
          ...
          <div className="container mx-auto flex items-center justify-between">
            ...
            <div className="text-sm text-gray-600 flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                {aiResponseText && <div className="text-xs text-gray-700">AI suggestion ready.</div>}
              </div>
            </div>
          </div>
        </header>
