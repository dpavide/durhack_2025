...
function UserMenu({ email }: { email: string }) {
    ...
    const displayEmail = email.includes("@") ? email : `User: ${email.substring(0, 8)}...`;
    ...
    return (
        <div className="relative">
            ...
            >
                ...
                <span className="max-w-[180px] truncate font-medium">{displayEmail}</span>
            </button>
            {open && (
            ...
            <main className="flex min-h-screen w-full max-w-lg flex-col items-center justify-between py-20 px-8 bg-white rounded-2xl shadow-2xl border border-gray-100">
                ...
                <div className="flex flex-col items-center gap-4 text-center mb-20">
                    <div className="bg-blue-100 p-4 rounded-full mb-2 shadow-inner">
                        <svg className="w-12 h-12 text-blue-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><path d="M18 22a7 7 0 0 0 3-5v-1a4 4 0 0 0-4-4"/><circle cx="9" cy="7" r="4"/><circle cx="15" cy="9" r="2"/>
                        </svg>
                    </div>
